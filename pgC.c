			...
			for(x = 0; x < numCols; x++){
				...
				if((i >> x) & 1 == 1)
					for(y = x+1; y < numCols; y++){
						...
						//IN TEN COLS FOR SOME REASON NUMCOLS GETS SET TO SOMETHING HUGE HERE??
						//IN 15 COLS IT BECOMES SOMETHING TINY -> THIS FUNCTION GETS MESSED UP BECAUSE NUMCOLS GETS RESET BUT WHERE AND WHY?
